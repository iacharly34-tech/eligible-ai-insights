...
const copy = {
  fr: {
    ...
    bullets: [
      ...
      "Sources officielles INPI · Sirene · BODACC + enrichissement dirigeant (Pappers, Kaspr)",
      "Score expliqué + plan d'action prêt à envoyer (email · LinkedIn · téléphone · courrier)",
    ],
    ctaPrimary: "Démarrer le pilote 14 jours",
    ctaSecondary: "Discuter sur WhatsApp",
    ctaNote: "Pilote 14 jours · sans carte bancaire · sans engagement.",
    ...
    mailSubjectA: "Digest du matin —",
    mailSubjectB: "Top 3 à contacter aujourd'hui",
  ...
  en: {
    ...
    bullets: [
      ...
      "Official sources INPI · Sirene · BODACC + founder enrichment (Pappers, Kaspr)",
      "Explained score + ready-to-send action plan (email · LinkedIn · phone · mail)",
    ],
    ctaPrimary: "Start the 14-day pilot",
    ctaSecondary: "Chat on WhatsApp",
    ctaNote: "14-day pilot · no credit card · no commitment.",
    ...
    mailSubjectA: "Morning digest —",
    mailSubjectB: "Top 3 to contact today",
