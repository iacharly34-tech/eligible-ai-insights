...
const faqs = [
  ...
  { q: "Pourquoi pas faire ça en interne avec un dev ?", a: "Vous pouvez. Comptez 3-6 mois de dev, intégrations INPI/Sirene/BODACC/Pappers, entraînement des modèles IA de filtrage et scoring, connecteurs vers vos outils, maintenance continue. Eligibly est livré, à jour quotidiennement, à 290 € HT/mois." },
