...
const faqs = [
  ...
  { q: "Que se passe-t-il après les 14 jours de pilote gratuit ?", a: "Vous décidez : continuer sur notre forfait mensuel flat (par carte bancaire ou virement), ou arrêter sans aucune obligation. Le tarif vous est communiqué dès le premier échange. Aucune relance commerciale agressive, aucune carte bancaire demandée à l'inscription." },
  { q: "Pourquoi ne pas afficher le tarif sur le site ?", a: "Notre forfait est unique, mais nous préférons le communiquer après un échange de cadrage de 20 minutes : c'est l'occasion de vérifier que votre verticale, votre zone et votre volume cible correspondent à notre périmètre, et que la valeur attendue est claire des deux côtés. C'est aussi une marque de respect pour nos clients déjà actifs — nous évitons toute communication tarifaire publique qui pourrait être instrumentalisée. Vous recevez notre proposition écrite sous 24 h ouvrées, sans engagement." },
