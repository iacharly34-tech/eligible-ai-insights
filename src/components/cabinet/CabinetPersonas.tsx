...
const copy = {
  fr: {
    eyebrow: "Pour qui",
    h2a: "Quatre profils de cabinets que",
    h2b: "nous équipons",
    items: [
  ...
  en: {
    ...
    h2a: "Four firm profiles we",
    h2b: "equip",
    items: [
      { l: "A", t: "Independent firms, 5 to 30 staff", d: "Well-established already, word-of-mouth no longer cuts it." },
      { l: "B", t: "Firms structuring their growth motion", d: "A business development lead or partner wants a vertical, turnkey tool." },
      { l: "C", t: "Vertical-specialist firms", d: "Tech, consulting, health, trades, real estate — only the first-time founders in your vertical." },
      { l: "D", t: "Firms going through partner transition", d: "Partner exit, succession, reorg: rebuild a steady inflow quickly." },
    ],
  },
} as const;
