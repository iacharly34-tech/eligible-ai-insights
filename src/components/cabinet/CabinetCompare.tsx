...
const labels = {
  fr: {
    eyebrow: "Comparatif",
    h2a: "Produire ses leads en interne ou",
    h2b: "les acheter à un tiers",
    sub: "La plupart des cabinets comparent Eligibly à un annuaire d'entreprises ou à un outil de prospection généraliste. La bonne référence est ailleurs : c'est la ligne budgétaire que vous consacrez aujourd'hui à un fournisseur de leads partagés. Lecture critère par critère.",
    col0: "Critère d'évaluation",
    eligiblyTag: "Production de leads en interne",
    supplierName: "Fournisseur tiers",
    supplierTag: "Achat de leads à l'unité",
    bottom: [
  ...
  en: {
    eyebrow: "Comparison",
    h2a: "Producing leads in-house vs.",
    h2b: "buying them from a third party",
    sub: "Most firms compare Eligibly to a business directory or a generic prospecting tool. The right reference point sits elsewhere: the budget line you currently spend with a shared-lead provider. Side-by-side review.",
    col0: "Evaluation criterion",
    eligiblyTag: "In-house lead production",
    supplierName: "Third-party provider",
    supplierTag: "Per-unit lead purchase",
    bottom: [
