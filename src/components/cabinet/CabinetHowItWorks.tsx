...
const STEPS_FR = [
  {
    ...
    output: "Flux brut",
    desc: "Ingestion continue des immatriculations, modifications statutaires et publications légales. Sources officielles uniquement, pas de scraping sauvage.",
  },
  {
    n: "02",
    icon: Layers,
    title: "Dédoublonnage par IA",
    short: "Base unifiée",
    output: "Base unifiée",
    desc: "Modèles d'appariement (embeddings + règles) qui normalisent SIREN, dénomination et dirigeant. Fusion des doublons entre sources pour une seule fiche de référence.",
  },
  {
    n: "03",
    icon: Filter,
    title: "Exclusions IA amont",
    short: "Vivier adressable",
    output: "Vivier adressable",
    desc: "Classifieurs IA : CAC mandaté, procédures collectives, cessations, holdings pures, serial entrepreneurs, sociétés > 90 jours. Règles auditables, décisions traçables.",
  },
  {
    n: "04",
    icon: Sparkles,
    title: "Enrichissement multi-touchpoints IA",
    short: "Fiche 360°",
    output: "Fiche complète multi-canaux",
    desc: "Touchpoints dirigeant : email pro vérifié, téléphone professionnel, LinkedIn, adresse postale du siège. Profil, verticale, capital et indicateurs de maturité du projet — agrégés par notre pipeline IA.",
  },
  {
    n: "05",
    icon: Brain,
    ...
    desc: "Score 0-100 sur votre ICP cabinet. 3 raisons clés affichées : signaux positifs, points à vérifier, priorité. Modèles open-weights hébergés en UE — décisions auditables, jamais en boîte noire.",
  },
  {
    n: "06",
    icon: Send,
    title: "Livraison + recommandation d'accroche IA",
    short: "Action commerciale",
    output: "Action commerciale",
    desc: "Push automatique dans vos canaux (email, Slack, Teams, WhatsApp). Pour chaque lead, une recommandation d'accroche IA personnalisée (email + LinkedIn) prête à envoyer. Vos feedbacks qualifié/écarté réentraînent en continu votre modèle propre.",
  },
];

const STEPS_EN = [
  { n: "01", icon: Database, title: "Real-time collection", short: "Public registries", output: "Raw feed", desc: "Continuous ingestion of registrations, statutory changes and legal publications. Official sources only, no rogue scraping." },
  { n: "02", icon: Layers, title: "AI-powered deduplication", short: "Unified base", output: "Unified base", desc: "Matching models (embeddings + rules) that normalize SIREN, legal name and director. Cross-source duplicate merge into a single reference record." },
  { n: "03", icon: Filter, title: "Upstream AI exclusions", short: "Addressable pool", output: "Addressable pool", desc: "AI classifiers: mandated auditor, insolvency, dissolution, pure holdings, serial founders, companies > 90 days. Auditable rules, traceable decisions." },
  { n: "04", icon: Sparkles, title: "Multi-touchpoint AI enrichment", short: "360° profile", output: "Full multi-channel profile", desc: "Founder touchpoints: verified work email, work phone, LinkedIn, registered postal address. Profile, vertical, capital and project maturity indicators — aggregated by our AI pipeline." },
  { n: "05", icon: Brain, title: "Explainable AI scoring", short: "Prioritized lead", output: "Prioritized lead", desc: "0–100 score on your firm's ICP. 3 key reasons shown: positive signals, points to verify, priority. EU-hosted open-weight models — auditable decisions, never a black box." },
  { n: "06", icon: Send, title: "Delivery + AI outreach recommendation", short: "Sales action", output: "Sales action", desc: "Auto-push into your channels (email, Slack, Teams, WhatsApp). For each lead, a personalized AI outreach recommendation (email + LinkedIn) ready to send. Your qualified/discarded feedback continuously retrains your own model." },
];
