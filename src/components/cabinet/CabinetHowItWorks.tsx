...
const STEPS_EN = [
  { n: "01", icon: Database, title: "Collection", short: "Public registries", output: "Raw feed", desc: "Daily ingestion of registrations, statutory changes and legal publications. Official sources only." },
  { n: "02", icon: Layers, title: "Deduplication", short: "Unified base", output: "Unified base", desc: "SIREN, legal name and director normalization. Cross-source duplicate merge into a single reference record." },
  { n: "03", icon: Filter, title: "Upstream exclusions", short: "Addressable pool", output: "Addressable pool", desc: "AI filters: mandated auditor, insolvency, dissolution, pure holdings, serial founders, companies > 90 days." },
  { n: "04", icon: Sparkles, title: "Enrichment", short: "Full profile", output: "Full profile", desc: "Adds work contact signals, founder profile, vertical, capital and project maturity indicators." },
  { n: "05", icon: Brain, title: "Explainable AI scoring", short: "Prioritized lead", output: "Prioritized lead", desc: "0–100 score on your firm's ICP. 3 key reasons shown: positive signals, points to verify, priority." },
  { n: "06", icon: Send, title: "Targeted delivery", short: "Sales action", output: "Sales action", desc: "Auto-push into your channels. Your qualified/discarded feedback continuously retrains your own model." },
];
