...
const steps = [
  ...
  { n: "04", title: "Alertes livrées", body: "Push automatique chaque matin dans vos canaux et outils de prospection. Vos retours réentraînent le scoring sur ce qui signe chez vous." },
];
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-2xl mb-14">
          ...
          <h2 className="font-display text-3xl md:text-4xl font-semibold tracking-tight text-foreground leading-tight">
            De la donnée brute à <em className="italic text-primary font-medium">une alerte directe</em>, en 4 étapes.
          </h2>
        </div>
