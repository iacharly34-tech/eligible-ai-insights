        ...
        <div className="grid lg:grid-cols-6 gap-10">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed max-w-sm">
              {language === 'en'
                ? 'The lead detection engine for French accounting firms. Newly registered SASU, SAS, EURL, SARL and SEL, AI-filtered and scored, delivered every morning to your preferred channel. From €10 per qualified lead — 14-day free pilot, no credit card.'
                : "Le moteur de détection de nouveaux clients pour cabinets d’expertise comptable. SASU, SAS, EURL, SARL et SEL fraîchement immatriculées, filtrées et scorées par notre IA, livrées chaque matin dans votre canal de travail. À partir de 10 € le lead qualifié — pilote 14 jours sans carte bancaire."}
            </p>
