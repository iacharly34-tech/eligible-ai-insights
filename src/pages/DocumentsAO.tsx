          ...
          <article className="container mx-auto max-w-4xl px-4">
            ...
            <section className="prose prose-lg max-w-none mb-12">
              ...
              <blockquote className="border-l-4 border-blue-500 pl-6 my-8 bg-blue-50/50 py-4 rounded-r-lg">
                ...
                <cite className="text-sm text-gray-600">— Retour d'expérience Eligibly</cite>
              </blockquote>
            </section>

            {/* Vue d'ensemble */}
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-6 text-gray-900">Vue d'ensemble du DCE</h2>
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-6 text-gray-900">Analyse détaillée de chaque document</h2>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <h4 className="font-bold text-sm mb-2 text-green-600">Points de vigilance :</h4>
                        <ul className="space-y-2 text-sm text-gray-600 mb-4">
                          <li className="flex items-start gap-2">
                            <CheckCircle className="w-4 h-4 text-green-500 flex-shrink-0 mt-0.5" />
            ...
            {/* Ordre de lecture */}
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-6 text-gray-900">L'ordre optimal de lecture</h2>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-4 p-4 bg-blue-50 rounded-xl">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Pour décider Go/No Go rapidement</p>
                      </div>
                    ...
                    <div className="flex items-center gap-4 p-4 bg-amber-50 rounded-xl">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Pour comprendre le besoin technique</p>
                      </div>
                    ...
                    <div className="flex items-center gap-4 p-4 bg-green-50 rounded-xl">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Pour estimer le prix et la rentabilité</p>
                      </div>
                    ...
                    <div className="flex items-center gap-4 p-4 bg-purple-50 rounded-xl">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Pour évaluer les risques contractuels</p>
                      </div>
                    ...
                    <div className="flex items-center gap-4 p-4 bg-slate-50 rounded-xl">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Pour finaliser et signer</p>
                      </div>
