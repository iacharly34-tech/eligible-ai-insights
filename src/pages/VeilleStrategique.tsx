        ...
        <main className="pt-32 pb-20">
          <article className="container mx-auto max-w-4xl px-4">
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-6 text-foreground">Pourquoi la veille est-elle cruciale ?</h2>
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                <Card className="border-0 shadow-lg">
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">Le délai moyen de réponse est de 25 jours. Découvrir un AO une semaine après sa publication peut vous être fatal.</p>
                  </CardContent>
                </Card>
                ...
                <Card className="border-0 shadow-lg">
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">La veille ne s'arrête pas aux publications. Les signaux faibles permettent d'anticiper les futurs marchés.</p>
                  </CardContent>
                </Card>
              </div>
            </section>
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-6 text-foreground">Les sources incontournables à surveiller</h2>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-muted-foreground mb-3">Les sources légales et obligatoires de publication des marchés publics.</p>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-muted-foreground mb-3">Pour détecter les marchés avant qu'ils ne soient publiés.</p>
                        <ul className="space-y-2 text-sm text-muted-foreground">
                          <li className="flex items-start gap-2">
                            <CheckCircle className="w-4 h-4 text-success flex-shrink-0 mt-0.5" />
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-muted-foreground mb-3">Pour comprendre le contexte et affiner votre stratégie.</p>
                        <ul className="space-y-2 text-sm text-muted-foreground">
                          <li className="flex items-start gap-2">
                            <CheckCircle className="w-4 h-4 text-success flex-shrink-0 mt-0.5" />
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-6 text-foreground">Comment structurer sa veille</h2>
                ...
                <CardContent className="p-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-card p-4 rounded-xl">
                      ...
                      <p className="text-sm text-muted-foreground">Définissez votre zone d'intervention. Inutile de surveiller toute la France si vous intervenez uniquement en Île-de-France.</p>
                    </div>
                    
                    <div className="bg-card p-4 rounded-xl">
                      <h4 className="font-bold mb-2 text-violet-700">2. Sectoriel</h4>
                      <p className="text-sm text-muted-foreground">Ciblez les codes CPV correspondant à votre activité. Soyez précis pour éviter le bruit.</p>
                    </div>
                    
                    <div className="bg-card p-4 rounded-xl">
                      <h4 className="font-bold mb-2 text-violet-700">3. Volumétrique</h4>
                      <p className="text-sm text-muted-foreground">Filtrez par montant estimé. Ne perdez pas de temps sur des marchés trop petits ou trop gros pour vous.</p>
                    </div>
                    
                    <div className="bg-card p-4 rounded-xl">
                      <h4 className="font-bold mb-2 text-violet-700">4. Type d'acheteur</h4>
                      <p className="text-sm text-muted-foreground">Ciblez vos acheteurs préférentiels : collectivités, établissements publics, État...</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-6 text-foreground">Les 5 erreurs de veille à éviter</h2>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-sm">Faire sa veille une fois par semaine n'est pas suffisant. Les meilleurs marchés peuvent se jouer en quelques jours.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-sm">Recevoir 200 alertes par jour vous noie dans l'information. Préférez des filtres précis quitte à les élargir ensuite.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-sm">Se limiter aux publications officielles, c'est réagir quand il est déjà presque trop tard.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-sm">Détecter un marché ne suffit pas. Il faut immédiatement évaluer sa pertinence (Go/No Go).</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-sm">La veille doit être partagée dans l'équipe. Un commercial peut repérer un marché technique et vice-versa.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
            ...
            {/* Charly */}
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-6 text-foreground">Comment Charly révolutionne la veille</h2>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Alertes en temps réel dès la publication d'un marché correspondant à vos critères.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Recommandation instantanée sur la pertinence de répondre.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Signaux faibles et marchés à venir pour vous préparer en amont.</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="bg-gradient-to-r from-violet-500 to-purple-500 rounded-3xl p-8 md:p-12 text-white text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <SafeLink to="/demo">
                  <Button size="lg" className="bg-card text-violet-600 hover:bg-violet-50">
