...
const GuideDemarchageClientCabinet = () => (
  <ArticleShell
    ...
    related={[
      ...
      { title: "Playbook 2026 — La prospection en cabinet EC", href: "/blog/playbook-prospection-cabinet-ec-2026" },
    ]}
  >
    <p>
    ...
    <p>
      Ce guide couvre le cadre déontologique, la construction d'une <strong>présence digitale</strong> (site, SEO, LLM), la <strong>présence sociale</strong>, la <strong>fluidification des canaux de contact</strong> (Slack, WhatsApp), le démarchage direct, et le <strong>timing d'immatriculation</strong> — le levier n°1 pour croître sans dépendre du bouche-à-oreille.
    </p>
    ...
    <ul>
      ...
      <li>Rester loyal, sincère et vérifiable sur les prestations décrites ;</li>
      <li>Ne rien promettre d'incompatible avec le devoir de conseil et l'indépendance ;</li>
    ...
    <ul>
      <li>Le <strong>churn naturel</strong> (dirigeants qui vendent, ferment, changent de cabinet) ;</li>
    ...
    <ul>
      ...
      <li><strong>LinkedIn</strong> : un post / semaine + messages personnalisés à l'ICP.</li>
      <li><strong>Email + appel</strong> à des dirigeants récemment immatriculés sur la verticale ciblée.</li>
    </ul>
...
export default GuideDemarchageClientCabinet;