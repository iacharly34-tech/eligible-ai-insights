          ...
          <article className="container mx-auto max-w-4xl px-4">
            ...
            <section className="prose prose-lg max-w-none mb-12">
              ...
              <blockquote className="border-l-4 border-cyan-500 pl-6 my-8 bg-cyan-50/50 py-4 rounded-r-lg">
                ...
                <cite className="text-sm text-gray-600">— Expert marchés publics, Eligibly</cite>
              </blockquote>
            </section>

            {/* Le droit au débriefing */}
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-6 text-gray-900">Votre droit au débriefing</h2>
                ...
                <CardContent className="p-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="flex items-start gap-3">
                      ...
                      <span className="text-gray-700">Les notes obtenues sur chaque critère</span>
                    </div>
                    <div className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                      <span className="text-gray-700">Le classement de votre offre</span>
                    </div>
                    <div className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                      <span className="text-gray-700">Le nom de l'attributaire</span>
                    </div>
                    <div className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                      <span className="text-gray-700">Les caractéristiques de l'offre retenue</span>
                    </div>
                    <div className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                      <span className="text-gray-700">Les motifs détaillés du rejet</span>
                    </div>
                    <div className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                      <span className="text-gray-700">Un rendez-vous téléphonique ou physique</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-6 text-gray-900">Comment analyser efficacement les retours</h2>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">Rassemblez toutes les informations : notes, commentaires de l'acheteur, rapport d'analyse si disponible. Conservez-les dans un tableau de suivi.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">Où avez-vous perdu des points ? Sur le prix ? La technique ? Les références ? Comparez avec vos prévisions internes.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">Qui a gagné ? À quel prix ? Avec quelle offre technique ? Ces informations sont souvent publiques après attribution.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">Qu'auriez-vous pu faire différemment ? Le marché était-il gagnable ? Si non, pourquoi avez-vous répondu ?</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">Formalisez les apprentissages : ajustez votre grille Go/No Go, vos modèles de mémoire technique, votre stratégie de pricing.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-6 text-gray-900">Les indicateurs clés à suivre</h2>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                <Card className="border-0 shadow-lg">
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-gray-600">Nombre de marchés gagnés / Nombre de réponses</p>
                ...
                <Card className="border-0 shadow-lg">
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-gray-600">Moyenne des notes techniques obtenues</p>
                ...
                <Card className="border-0 shadow-lg">
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-gray-600">Heures investies par dossier</p>
                ...
                <Card className="border-0 shadow-lg">
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-gray-600">Votre prix vs prix retenu</p>
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-6 text-gray-900">Transformer les échecs en opportunités</h2>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Remerciez l'acheteur pour le débriefing. Montrez que vous êtes dans une démarche d'amélioration.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Demandez à être informé des prochaines consultations. Montrez votre intérêt pour la collectivité.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Créez une fiche acheteur avec ses préférences, ses critères réels, ses attentes non écrites.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Le marché sera relancé. Positionnez-vous dès maintenant avec les bonnes informations.</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            {/* Comment Charly aide */}
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-6 text-gray-900">L'analyse de retours avec Charly</h2>
