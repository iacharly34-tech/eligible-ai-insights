...
const copy = {
  fr: {
    ...
    liveArticles: [
      ...
      { href: "/blog/guide-demarchage-client-expert-comptable", title: "Guide du démarchage client pour experts-comptables", desc: "Cadre déontologique post-2014, méthode marketing en 5 étapes, canaux (LinkedIn, email, réseau, timing d'immatriculation) et erreurs à éviter. Sources OEC, Compta Online, RFC, Shine.", meta: "27 juil. 2026 · 10 min · Développement cabinet · sources OEC, Compta Online, RFC, Shine" },
