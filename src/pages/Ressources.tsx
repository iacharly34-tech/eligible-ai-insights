...
const copy = {
  fr: {
    ...
    featuredBadge: "Simulateur inclus",
    featuredCta: "Lancer le simulateur",
    ...
    liveArticles: [
      { href: "/blog/cas-client-empartners", title: "Cas client Empartners : 3 leads qualifiés par semaine", desc: "Comment Eligibly a accompagné Mickael Beddok et Empartners.fr de l'image de marque au site web, en passant par le référencement local et la prospection ciblée depuis février 2026.", meta: "24 août 2026 · 9 min · Cas client cabinet EC" },
      { href: "/blog/barometre-immatriculations-juillet-2026", title: "Baromètre des nouvelles sociétés commerciales — Juillet 2026", desc: "718 sociétés analysées au 21/07, +11,8% vs juin, concentration Tech/Conseil/E-commerce/CHR, capital médian 1 000 €. Sept signaux structurés pour lire le marché.", meta: "9 min · Baromètre · Insights by Eligibly" },
      { href: "/blog/creer-site-web-expert-comptable-guide", title: "Créer le site web d'un cabinet d'expertise comptable — guide 2026", desc: "Positionnement et ICP, arborescence type, tunnel de contact, socle technique et Core Web Vitals, conformité déontologique et RGPD, budget et délais réels, indicateurs à suivre.", meta: "3 sept. 2026 · 15 min · Guide site web cabinet" },
      { href: "/blog/referencement-local-expert-comptable", title: "Référencement local d'un expert-comptable — méthode complète", desc: "Fiche Google Business Profile, avis, cohérence NAP, pages locales et verticales, netlinking de proximité, visibilité dans les assistants IA. Plan d'action 90 jours et KPIs.", meta: "3 sept. 2026 · 14 min · Guide référencement local" },
      { href: "/blog/guide-demarchage-client-expert-comptable", title: "Kit marketing 2026 pour experts-comptables", desc: "Cadre déontologique post-2014, checklist présence digitale (site, SEO, LLM), présence sociale, canaux fluides (Slack, WhatsApp), timing d'immatriculation. Cas Empartners : 3 leads / semaine en 3 mois.", meta: "27 juil. 2026 · 12 min · Kit marketing cabinet · sources CNOEC, INSEE, Légifrance, cas Empartners" },
      { href: "/blog/moderniser-cabinet-etat-lieux-2026", title: "Le Signal N°1 — Moderniser son cabinet : l'état des lieux 2026", desc: "20 Md€ de CA, 21 288 cabinets, 77% des entreprises accompagnées, 232 000 futurs clients / an, 60% de temps gagné avec l'IA. Tous les chiffres, sourcés et datés.", meta: "10 min · État des lieux · sources CNOEC, INSEE, Cegid" },
      { href: "/blog/5-leviers-croissance-cabinet-expertise-comptable", title: "5 leviers concrets pour provoquer la croissance d'un cabinet", desc: "Réseau prescripteur, spécialisation, automatisation, LinkedIn, timing de création : les cinq mouvements qui remettent la croissance entre vos mains.", meta: "6 min · Croissance cabinet" },
  ...
  en: {
    ...
    featuredBadge: "Simulator included",
    featuredCta: "Launch the simulator",
    onlineBadge: "Live",
    read: "Read",
    ...
    liveArticles: [
      { href: "/en/blog/empartners-case-study", title: "Empartners case study: 3 qualified leads per week", desc: "How Eligibly supported Mickael Beddok and Empartners.fr from branding and website to local SEO and targeted prospecting since February 2026.", meta: "24 Aug 2026 · 9 min · Accounting firm case study" },
      { href: "/en/blog/registrations-barometer-july-2026", title: "Barometer of new commercial companies — July 2026", desc: "718 companies analysed on 21/07, +11.8% vs June, Tech/Consulting/E-commerce/CHR concentration, median capital €1,000. Structured signals for accounting firms.", meta: "9 min · Barometer · Insights by Eligibly" },
      { href: "/en/blog/modernise-accounting-firm-2026", title: "The Signal N°1 — Modernise your firm: 2026 state of play", desc: "€20bn revenue, 21,288 firms, 77% of businesses served, 232,000 future clients / year, 60% time saved with AI. All figures, sourced and dated.", meta: "10 min · State of play · sources CNOEC, INSEE, Cegid" },
      { href: "/en/blog/5-growth-levers-accounting-firm", title: "5 concrete levers to provoke growth in an accounting firm", desc: "Referral network, specialisation, automation, LinkedIn, incorporation timing: the five movements that put growth back in your hands.", meta: "6 min · Firm growth" },
