...
const copy = {
  fr: {
    ...
    liveArticles: [
      ...
      { href: "/blog/guide-demarchage-client-expert-comptable", title: "Guide du démarchage client pour experts-comptables", desc: "Cadre déontologique post-2014, présence digitale (site, SEO, LLM), présence sociale, canaux fluides (Slack, WhatsApp), timing d'immatriculation. Cas Empartners : 3 leads / semaine en 3 mois.", meta: "27 juil. 2026 · 12 min · Développement cabinet · sources OEC, INSEE, Légifrance, cas Empartners" },
