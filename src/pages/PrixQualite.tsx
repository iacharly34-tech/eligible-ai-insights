          ...
          <article className="container mx-auto max-w-4xl px-4">
            ...
            <section className="prose prose-lg max-w-none mb-12">
              ...
              <blockquote className="border-l-4 border-emerald-500 pl-6 my-8 bg-emerald-50/50 py-4 rounded-r-lg">
                ...
                <cite className="text-sm text-muted-foreground">— Analyse Eligibly sur 50 000 attributions</cite>
              </blockquote>
            </section>

            {/* Comprendre les critères */}
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-6 text-foreground">Comprendre les critères de notation</h2>
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                ...
                <Card className="border-0 shadow-lg">
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">Stratégie : optimiser les deux axes</p>
                  </CardContent>
                </Card>
                ...
                <Card className="border-0 shadow-lg">
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-sm text-muted-foreground">Stratégie : excellence technique, prix raisonnable</p>
                  </CardContent>
                </Card>
              </div>
            </section>
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-6 text-foreground">Les 5 erreurs fatales de pricing</h2>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-sm">Proposer toujours le prix le plus bas détruit vos marges et vous positionne comme low-cost. Les acheteurs se méfient des offres anormalement basses.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-sm">Sur un marché où le prix compte pour 70%, investir massivement dans le mémoire technique est une perte de temps et d'argent.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-sm">Appliquer les mêmes tarifs d'un marché à l'autre sans analyser le contexte local et la concurrence probable.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-sm">Oublier les frais de déplacement, la gestion administrative, les imprévus... et se retrouver à exécuter un marché à perte.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-sm">Gagner un marché non rentable est pire que de le perdre. Définissez votre prix plancher avant de commencer.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
            ...
            {/* La méthode optimale */}
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-6 text-foreground">La méthode du positionnement optimal</h2>
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-6 text-foreground">Stratégies par type de marché</h2>
            ...
            {/* Comment Charly aide */}
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-6 text-foreground">L'IA au service de votre pricing</h2>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Charly identifie les fourchettes de prix gagnantes sur des marchés similaires.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Estimez le positionnement probable de vos concurrents.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Vérifiez que votre prix respecte vos contraintes de marge.</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="bg-success/10 border border-success/20 rounded-3xl p-8 md:p-12 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <SafeLink to="/demo">
                  <Button size="lg" className="bg-card text-emerald-600 hover:bg-emerald-50">
                    Tester gratuitement
