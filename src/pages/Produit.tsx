        ...
        <main>
          ...
          <section className="py-20 md:py-28 px-4 bg-card/30">
            <div className="container mx-auto max-w-3xl text-center">
              <p className="text-[0.74rem] uppercase tracking-[0.14em] text-primary font-semibold mb-4">Livraison</p>
              ...
              <div className="flex items-center justify-center gap-4 text-sm text-muted-foreground mb-8">
                ...
                <span>Email · rafraîchissement quotidien · pas de double saisie</span>
              </div>
              <p className="text-sm text-muted-foreground">
                <Slack className="inline-block w-4 h-4 text-primary mr-1 align-text-bottom" />
                Intégrations Slack et Microsoft Teams disponibles sur demande pour les cabinets qui souhaitent recevoir le digest dans leur canal d'équipe.
              </p>
            </div>
          </section>
