...
const copy = {
  fr: {
    ...
    guarSub: "Pas de carte bancaire pour démarrer. Échantillon de 3 leads livré sous 48 h pour valider la qualité avant signature. Engagement mensuel, résiliable avec préavis 30 jours.",
