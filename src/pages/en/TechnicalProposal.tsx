          ...
          <article className="container mx-auto max-w-4xl px-4">
            ...
            <section className="prose prose-lg max-w-none mb-12">
              ...
              <blockquote className="border-l-4 border-emerald-500 pl-6 my-8 bg-emerald-50/50 py-4 rounded-r-lg">
                ...
                <cite className="text-sm text-muted-foreground">— CIPS Procurement Research 2025</cite>
              </blockquote>
            </section>

            {/* Structure */}
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-6 text-foreground">Essential structure of a technical proposal</h2>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-sm">A compelling one-page overview of your solution and key differentiators. Write this last but put it first.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-sm">Demonstrate that you truly understand the buyer&apos;s needs, challenges, and objectives. Restate key requirements in your own words.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-sm">Detail your approach, phases, deliverables, and timelines. Be specific and realistic.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-sm">Present your team&apos;s qualifications, CVs, and the resources you will dedicate to the project.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-sm">Showcase case studies and references that prove your capability to deliver similar projects.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-sm">Highlight what makes your offer unique: innovation, social value, sustainability, risk mitigation.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
            ...
            {/* Key Success Factors */}
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-6 text-foreground">Key success factors</h2>

              <div className="grid md:grid-cols-2 gap-6">
                <Card className="border-success/20 bg-success/10/50">
                  <CardContent className="p-6">
                    <CheckCircle className="w-8 h-8 text-success mb-4" />
                    <h3 className="font-bold mb-3 text-success">Do</h3>
            ...
            {/* Writing Tips */}
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-6 text-foreground">Professional writing tips</h2>
                ...
                <CardContent className="p-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Short sentences. Active voice. One idea per paragraph. Evaluators read dozens of bids—make yours easy to score.</p>
                    </div>
                    
                    <div>
                      <h4 className="font-bold mb-2">Evidence-based</h4>
                      <p className="text-sm text-muted-foreground">Every claim should be supported. Use numbers, dates, client names, and measurable outcomes.</p>
                    </div>
                    
                    <div>
                      <h4 className="font-bold mb-2">Buyer-focused</h4>
                      <p className="text-sm text-muted-foreground">Write from the buyer&apos;s perspective. Focus on their benefits, not your features.</p>
                    </div>
                    
                    <div>
                      <h4 className="font-bold mb-2">Compliant structure</h4>
                      <p className="text-sm text-muted-foreground">Follow the exact structure requested. Number your sections to match the evaluation criteria.</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            {/* References Section */}
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-6 text-foreground">Presenting your references effectively</h2>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Describe the client, their challenge, and why they needed your services.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Quantify the outcomes: savings, efficiency gains, satisfaction scores.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">Explicitly link to the current tender requirements. Explain why this experience matters.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
            ...
            {/* How Charly Helps */}
            <section className="mb-12">
              <h2 className="text-2xl font-bold mb-6 text-foreground">How Charly accelerates your proposal writing</h2>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Charly identifies and organises all requirements from complex tender documents.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Ensure you have addressed every mandatory and scored requirement.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Find the most relevant case studies from your reference library.</p>
                  </div>
                </div>
              </div>
            </section>
              ...
              <Card className="border-0 shadow-2xl bg-gradient-to-r from-emerald-600 to-teal-700 text-white">
                <CardContent className="p-8 md:p-12 text-center">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <SafeLink to="/en/demo">
                      <Button size="lg" className="bg-card text-emerald-700 hover:bg-emerald-50">
                        Book a demo
