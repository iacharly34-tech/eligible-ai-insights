...
const translations = {
  fr: {
    ...
    'product.suite.badge': 'La suite Eligibly',
    'product.suite.title': '6 modules, une seule',
    'product.suite.title.highlight': 'plateforme',
    'product.suite.subtitle': 'Chaque étape du cycle des marchés publics est couverte par un module dédié. Plus besoin de jongler entre plusieurs outils — Eligibly remplace votre stack entier.',
    'product.suite.cta.text': 'Découvrez les 6 modules en action dans une démonstration personnalisée à votre métier.',
    'product.suite.detect.name': 'Detect',
    'product.suite.detect.title': 'Veille & détection automatique',
    'product.suite.detect.desc': 'Surveillance continue de 200+ sources officielles (BOAMP, PLACE, TED, profils acheteurs). Détection instantanée des appels d\'offres pertinents selon vos critères métier.',
    'product.suite.detect.cap1': '200+ sources françaises et européennes',
    'product.suite.detect.cap2': 'Alertes Slack, Teams, Email en temps réel',
    'product.suite.detect.cap3': 'Filtrage intelligent par secteur, zone et budget',
    'product.suite.analyze.name': 'Analyze',
    'product.suite.analyze.title': 'Analyse DCE & scoring IA',
    'product.suite.analyze.desc': 'L\'IA décompose chaque dossier de consultation en secondes : extraction des exigences, critères de notation, points de vigilance et synthèse stratégique.',
    'product.suite.analyze.cap1': 'Extraction automatique des exigences clés',
    'product.suite.analyze.cap2': 'Scoring de compatibilité profil/marché',
    'product.suite.analyze.cap3': 'Synthèse stratégique et points de vigilance',
    'product.suite.decide.name': 'Decide',
    'product.suite.decide.title': 'Go/No-Go prédictif',
    'product.suite.decide.desc': 'Évaluez la pertinence de chaque marché en 2 minutes. Score d\'adéquation, analyse des risques, estimation de la charge et recommandation stratégique.',
    'product.suite.decide.cap1': 'Score prédictif de réussite en pourcentage',
    'product.suite.decide.cap2': 'Analyse des risques et de la concurrence',
    'product.suite.decide.cap3': 'Recommandation IA : investir ou passer',
    'product.suite.write.name': 'Write',
    'product.suite.write.title': 'Rédaction mémoire technique IA',
    'product.suite.write.desc': 'Génération du mémoire technique à partir de vos références, CV et méthodologies. L\'IA s\'appuie sur votre savoir-faire via RAG, pas sur du contenu générique.',
    'product.suite.write.cap1': 'RAG personnalisé sur vos données internes',
    'product.suite.write.cap2': 'Plan structuré aligné sur les critères DCE',
    'product.suite.write.cap3': 'Export Word prêt à déposer',
    'product.suite.check.name': 'Check',
    'product.suite.check.title': 'Conformité & anti-omission',
    'product.suite.check.desc': 'Matrice de traçabilité automatique reliant chaque exigence DCE à votre réponse. Checklist de dépôt pour éliminer tout risque de rejet administratif.',
    'product.suite.check.cap1': 'Matrice de traçabilité exigence ↔ réponse',
    'product.suite.check.cap2': 'Détection d\'oublis et pièces manquantes',
    'product.suite.check.cap3': 'Checklist de dépôt pré-soumission',
    'product.suite.win.name': 'Win',
    'product.suite.win.title': 'Pilotage & performance',
    'product.suite.win.desc': 'Dashboard stratégique avec taux de succès réels, analyse des retours acheteurs, benchmark concurrentiel et optimisation continue de votre stratégie.',
    'product.suite.win.cap1': 'Taux de succès et ROI par type de marché',
    'product.suite.win.cap2': 'Analyse des retours acheteurs publics',
    'product.suite.win.cap3': 'Capitalisation et amélioration itérative',
  ...
  en: {
    ...
    // Product Suite (Modules)
    'product.suite.badge': 'The Eligibly Suite',
    'product.suite.title': '6 modules, one',
    'product.suite.title.highlight': 'platform',
    'product.suite.subtitle': 'Every step of the public procurement cycle is covered by a dedicated module. No more juggling between tools — Eligibly replaces your entire stack.',
    'product.suite.cta.text': 'See all 6 modules in action in a personalised demo tailored to your role.',
    'product.suite.detect.name': 'Detect',
    'product.suite.detect.title': 'Monitoring & automatic detection',
    'product.suite.detect.desc': 'Continuous monitoring of 200+ official sources (BOAMP, PLACE, TED, buyer profiles). Instant detection of relevant tenders based on your business criteria.',
    'product.suite.detect.cap1': '200+ French and European sources',
    'product.suite.detect.cap2': 'Real-time Slack, Teams & Email alerts',
    'product.suite.detect.cap3': 'Smart filtering by sector, area and budget',
    'product.suite.analyze.name': 'Analyze',
    'product.suite.analyze.title': 'DCE analysis & AI scoring',
    'product.suite.analyze.desc': 'AI breaks down each consultation file in seconds: requirement extraction, scoring criteria, red flags and strategic summary.',
    'product.suite.analyze.cap1': 'Automatic extraction of key requirements',
    'product.suite.analyze.cap2': 'Profile/tender compatibility scoring',
    'product.suite.analyze.cap3': 'Strategic summary and red flags',
    'product.suite.decide.name': 'Decide',
    'product.suite.decide.title': 'Predictive Go/No-Go',
    'product.suite.decide.desc': 'Assess each tender\'s relevance in 2 minutes. Fit score, risk analysis, workload estimation and strategic recommendation.',
    'product.suite.decide.cap1': 'Predictive success score as a percentage',
    'product.suite.decide.cap2': 'Risk and competition analysis',
    'product.suite.decide.cap3': 'AI recommendation: invest or pass',
    'product.suite.write.name': 'Write',
    'product.suite.write.title': 'AI technical proposal writing',
    'product.suite.write.desc': 'Technical proposal generation from your references, CVs and methodologies. AI builds on your expertise via RAG, not generic content.',
    'product.suite.write.cap1': 'Custom RAG on your internal data',
    'product.suite.write.cap2': 'Structured plan aligned with DCE criteria',
    'product.suite.write.cap3': 'Ready-to-submit Word export',
    'product.suite.check.name': 'Check',
    'product.suite.check.title': 'Compliance & anti-omission',
    'product.suite.check.desc': 'Automatic traceability matrix linking every DCE requirement to your response. Pre-submission checklist to eliminate any risk of administrative rejection.',
    'product.suite.check.cap1': 'Requirement ↔ response traceability matrix',
    'product.suite.check.cap2': 'Missing document and omission detection',
    'product.suite.check.cap3': 'Pre-submission deposit checklist',
    'product.suite.win.name': 'Win',
    'product.suite.win.title': 'Performance dashboard',
    'product.suite.win.desc': 'Strategic dashboard with real win rates, buyer feedback analysis, competitive benchmarks and continuous strategy optimisation.',
    'product.suite.win.cap1': 'Win rate and ROI by tender type',
    'product.suite.win.cap2': 'Public buyer feedback analysis',
    'product.suite.win.cap3': 'Capitalisation and iterative improvement',
