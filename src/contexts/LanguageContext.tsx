...
const translations = {
  fr: {
    ...
    'hero.subtitle': 'Notre plateforme d\'intelligence artificielle utilise des modèles de langage avancés (GPT-4, Claude, Mistral) pour analyser automatiquement plus de 600 sources officielles et identifier les opportunités commerciales adaptées à votre secteur.',
    ...
    'features.subtitle': 'Une suite complète d\'outils d\'intelligence artificielle et de modèles de langage (LLM) pour transformer votre approche des marchés publics',
    'features.multisource.title': 'Agrégation Multi-Sources IA',
    'features.multisource.desc': 'Connexion automatisée alimentée par l\'IA à plus de 600 plateformes officielles de marchés publics françaises et européennes',
    'features.ai.title': 'Analyse LLM Multi-Modèles',
    'features.ai.desc': 'Architecture d\'intelligence artificielle avancée combinant GPT-4, Claude et Mistral pour l\'analyse sémantique et le traitement du langage naturel des appels d\'offres',
    'features.scoring.title': 'Scoring par Machine Learning',
    'features.scoring.desc': 'Algorithmes d\'apprentissage automatique pour l\'évaluation prédictive de la pertinence et du potentiel commercial de chaque marché public',
    'features.notifications.title': 'Alertes IA Temps Réel',
    'features.notifications.desc': 'Système de notification intelligent basé sur l\'IA avec intégrations Slack, email et API personnalisées',
