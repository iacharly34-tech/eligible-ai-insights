...
const translations = {
  fr: {
    ...
    'hero.title.end': 'qui correspondent à votre entreprise',
    'hero.subtitle': 'Notre IA analyse plus de 600 sources officielles françaises et européennes pour identifier automatiquement les opportunités commerciales adaptées à votre secteur d\'activité.',
    'hero.cta.primary': 'Essayer gratuitement',
    'hero.cta.secondary': 'Voir la démo',
    'hero.stats.opportunities': '23 opportunités par jour en moyenne',
    ...
    'features.subtitle': 'Une suite complète d\'outils d\'intelligence artificielle pour transformer votre approche des marchés publics',
    'features.multisource.title': 'Connexion Multi-Sources',
    'features.multisource.desc': 'Accès automatisé à plus de 600 sources officielles de marchés publics françaises et européennes',
    'features.ai.title': 'Analyse IA Avancée',
    'features.ai.desc': 'Triple modèle d\'IA (GPT-4, Claude, Mistral) pour une analyse exhaustive des appels d\'offres',
    'features.scoring.title': 'Scoring Intelligent',
    'features.scoring.desc': 'Évaluation automatique de la pertinence et du potentiel de chaque marché public',
    'features.notifications.title': 'Notifications Temps Réel',
    'features.notifications.desc': 'Alertes instantanées via Slack, email et intégrations sur mesure',
    
    // CTA Section
    'cta.title': 'Prêt à transformer votre veille commerciale ?',
    'cta.subtitle': 'Rejoignez plus de 2 000 professionnels qui utilisent déjà notre IA',
